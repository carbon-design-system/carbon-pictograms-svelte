...
## [13.21.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.21.0) - 2026-09-24

**Features**

- upgrade `@carbon/pictograms` to v12.85.0 (net +1 pictogram)

## [13.20.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.20.0) - 2026-08-28

**Features**

- upgrade `@carbon/pictograms` to v12.83.0 (net +3 pictograms)

## [13.19.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.19.0) - 2026-07-02

**Features**

- upgrade `@carbon/pictograms` to v12.79.0 (net +9 pictograms)

## [13.18.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.18.0) - 2026-06-05

**Features**

- upgrade `@carbon/pictograms` to v12.77.0 (net +14 pictograms)

## [13.17.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.17.0) - 2026-05-09

**Features**

- upgrade `@carbon/pictograms` to v12.75.0 (net +8 pictograms)

## [13.16.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.16.0) - 2026-03-25

**Features**

- upgrade `@carbon/pictograms` to v12.72.0 (net +4 pictograms)

## [13.15.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.15.0) - 2026-02-28

**Features**

- upgrade `@carbon/pictograms` to v12.70.0 (net +17 pictograms)

## [13.14.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.14.0) - 2025-12-18

**Features**

- upgrade `@carbon/pictograms` to v12.66.0 (net +3 pictograms)

## [13.13.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.13.0) - 2025-12-03

**Features**

- upgrade `@carbon/pictograms` to v12.65.0 (net +50 pictograms)

## [13.12.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.12.0) - 2025-11-19

**Features**

- upgrade `@carbon/pictograms` to v12.64.0 (net +10 pictograms)

## [13.11.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.11.0) - 2025-10-08

**Features**

- upgrade `@carbon/pictograms` to v12.62.0 (net +49 pictograms)

## [13.10.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.10.0) - 2025-09-24

**Features**

- upgrade `@carbon/pictograms` to v12.61.0 (net +14 pictograms)

## [13.9.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.9.0) - 2025-08-13

**Features**

- upgrade `@carbon/pictograms` to v12.58.0 (net +16 pictograms)

## [13.8.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.8.0) - 2025-07-23

**Features**

- upgrade `@carbon/pictograms` to v12.56.0 (net +1 pictogram)

## [13.7.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.7.0) - 2025-07-02

**Features**

- upgrade `@carbon/pictograms` to v12.55.0 (net +10 pictograms)

## [13.6.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.6.0) - 2025-05-21

**Features**

- upgrade `@carbon/pictograms` to v12.52.0 (net +34 pictograms)

## [13.5.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.5.0) - 2025-04-23

**Features**

- upgrade `@carbon/pictograms` to v12.50.0 (net +38 pictograms)

## [13.4.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.4.0) - 2025-04-09
...
## [13.1.0](https://github.com/carbon-design-system/carbon-pictograms-svelte/releases/tag/v13.1.0) - 2025-02-03
